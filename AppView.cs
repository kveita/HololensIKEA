...
namespace HololensIKEA
{
    ...
    internal class AppView : IFrameworkView, IDisposable
    {
        ...
        public void SetWindow(CoreWindow window)
        {
            ...
            // Register for character input (elnummer entry).
            window.CharacterReceived += this.OnCharacterReceived;
        ...
        {
            if (null != main)
                main.OnKeyDown(args.VirtualKey);
        }

        private void OnCharacterReceived(CoreWindow sender, CharacterReceivedEventArgs args)
        {
            if (null != main)
                main.OnCharacterReceived((char)args.KeyCode);
        }
